 ...
 * @author EDWIN BALLEN
 */
public class Renault extends Loscoches {

    public Renault(String N_coche, String Tipo_de_servicio, int Precio, String Alta_g_Baja_g) {
    ...
    public void montrarDatos(){
        ...
        System.out.println("Nombre del coche 2: "+getN_coche());
